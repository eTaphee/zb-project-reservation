...
public class PartnerInventoryServiceImpl implements PartnerInventoryService {
    ...
    @Transactional
    @Override
    public CreateInventoryResponseDto createInventory(CreateInventoryRequestDto request) {
    ...
    private void validateCreateInventory(CreateInventoryRequestDto requestDto) {
...
//        if (LocalTime.now().plusHours(d))
    ...
    @Transactional
    @Override
    public UpdateInventoryResponseDto updateInventory(Long id, UpdateInventoryRequestDto request) {
        //  TODO: 재고 수량 체크
        // lock
